 ...
 */
final class Version20240310123202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE informations (id INT AUTO_INCREMENT NOT NULL, ip VARCHAR(255) NOT NULL, up TINYINT(1) NOT NULL, os VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
